...
namespace IkastenBot\Migrations;
 ...
 */
final class Version20190122125928 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ganttproject (id INT AUTO_INCREMENT NOT NULL, user_id BIGINT DEFAULT NULL COMMENT \'Unique user identifier\', file_name VARCHAR(255) NOT NULL, version INT NOT NULL, INDEX IDX_4EE13CF0A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
